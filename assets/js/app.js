...
jQuery(function ($) {
  ...
  function submitForm() {
    ...
    if (csrfToken) {
      $.ajax({
        type: "POST",
        url: "libs/contact-form-process.html",
  ...
  var vpsPriceInfo = [{
    ...
    "vpsBandwidth": 1000,
    "vpsPrice": 20,
    "vpsWHmcsUrl": "../../../themetags.net/whmcs/index_c068fc8a.php.html"
  }, {
    "vpsPlan": 2,
    "vpsCore": 2,
    "vpsMemory": 4,
    ...
    "vpsBandwidth": 2000,
    "vpsPrice": 40,
    "vpsWHmcsUrl": "../../../themetags.net/whmcs/index_47c495ff.php.html"
  }, {
    "vpsPlan": 3,
    "vpsCore": 3,
    "vpsMemory": 6,
    ...
    "vpsBandwidth": 3000,
    "vpsPrice": 60,
    "vpsWHmcsUrl": "../../../themetags.net/whmcs/index_ea679159.php.html"
  }, {
    "vpsPlan": 4,
    "vpsCore": 4,
    "vpsMemory": 8,
